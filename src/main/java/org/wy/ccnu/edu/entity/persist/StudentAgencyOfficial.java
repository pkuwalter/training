...
/**
 * 
 * @author lihaiyang May8,2014
 * 
 */
@Entity
@Table(name = "studentAgencyOfficial")
@XmlRootElement
public class StudentAgencyOfficial implements Serializable{ //学员单位人员信息
