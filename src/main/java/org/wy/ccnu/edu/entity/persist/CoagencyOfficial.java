...
@Entity
@Table(name = "coagencyOfficial")
@XmlRootElement
public class CoagencyOfficial {
private static final long serialVersionUID = 1L;
	
	private String id;                 //合作机构人员标识ID
	
	private String officialNum;        //合作机构人员编号
	...
	private String coagency;        //所属合作机构
